...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: "Accueil", icon: House },
      { type: "link", to: "/issues", label: "Tâches", icon: CircleDot },
      { type: "action", label: "Créer", icon: SquarePen, onClick: () => openNewIssue() },
