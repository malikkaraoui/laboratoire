...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: goal?.title ?? goalId ?? "Objectif" }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            Sous-Objectifs ({childGoals.length})
          </TabsTrigger>
          <TabsTrigger value="projects">
            Projets ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          ...
          {childGoals.length === 0 ? (
            <p className="text-sm text-muted-foreground">Aucun sous-objectif pour l'instant.</p>
          ) : (
        ...
        <TabsContent value="projects" className="mt-4">
          {linkedProjects.length === 0 ? (
            <p className="text-sm text-muted-foreground">Aucun projet lié pour l'instant.</p>
          ) : (
