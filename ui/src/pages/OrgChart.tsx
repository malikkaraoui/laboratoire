...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: "Organigramme" }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message="Sélectionnez une entreprise pour afficher l'organigramme." />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message="Aucune hiérarchie organisationnelle définie." />;
  }
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          ...
          <button
            ...
            aria-label="Ajuster le graphique à l'écran"
          >
